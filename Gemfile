...
gem 'devise-jwt', '~> 0.12'             # JWT for API authentication
gem 'jwt'
gem 'active_storage_validations', '~> 3.0' # For ActiveStorage validations
...
gem 'activeadmin', '~> 3.2'             # Admin panel
gem "sassc-embedded", "~> 1.77"             # Required for ActiveAdmin
# Gemfile
gem 'stripe'
gem 'fcm'
gem 'httparty'
